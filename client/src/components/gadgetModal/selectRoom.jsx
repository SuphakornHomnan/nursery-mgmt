...
import { showChild } from "../../redux/actions/gadget";
...
const SelectRoom = () => {
  ...
  const handleDate = (target) => {
    dispatch({ type: "SET_LOADING_SPINNER_GADGET", payload: false });
  ...
  return (
    <>
      <div className="selectMonthGadget">
        <div className="field">
      ...
      <div className="selectRoomGadget">
        <div className="field">
          <div
            className="control"
